...
function createActionMenu() {
    ...
    // Kept Simplify, Read, and Translate (Removed Explain)
    const actions = [
        { id: 'am-simplify', text: '🧩 Simplify' },
        { id: 'am-read', text: '🔊 Read' },
        { id: 'am-dict', text: '🌐 Translate' }
    ];
    ...
    document.getElementById('am-simplify').onclick = () => triggerSelectionAI('simplify');
...
function triggerSelectionAI(mode) {
    ...
    const readingLevel = window.currentSettings ? window.currentSettings.readingLevel : 'simple';
    const translateLang = window.currentSettings ? window.currentSettings.translateLang : 'en';
...
document.addEventListener('mousedown', (e) => {
    ...
    // Stop reading if user clicks elsewhere
